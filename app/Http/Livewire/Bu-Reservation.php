...
//        $this->selectedDepartureId = null;
        ...
        if(isset($this->departurePointId) && isset($this->arrivalPointId))
        {
            $this->queryDepartures();
        }else{
            $this->departures = [];
    ...
    {
        $this->subTotal = ($this->selectedDeparture->price - ($this->discount->amount ?? 0))
    ...
    public function updatedDeparturePointId()
    {
        $this->selectedDepartureId = null;
        $this->selectedDeparture = null;
    }

    public function updatedArrivalPointId()
    {
        $this->selectedDepartureId = null;
        $this->selectedDeparture = null;
    }
