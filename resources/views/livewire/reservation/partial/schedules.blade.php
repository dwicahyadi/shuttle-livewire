    ...
    <div style="height: 40rem; overflow-y: scroll">
        <ul class="list-group">
            @forelse($departures as $departure)
                <li class="list-group-item list-group-item-action @if($departure->id == $selectedDepartureId) bg-primary text-white @endif" wire:click="$emit('getDeparture', {{$departure->id}})" wire:key="{{$departure->id}}">
                    <div class="d-flex">
                        <div class="mr-2">
