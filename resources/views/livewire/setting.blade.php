                    ...
                    <div class="tab-pane fade show active" id="company" role="tabpanel" aria-labelledby="company-tab">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="company_logo" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Tagline</label>
                                <input type="text" wire:model="company_tagline" class="form-control">
                            </div>
                            <hr>
                            <div class="form-group">
                                <label>Bank</label>
                                <input type="text" wire:model="company_bank_account" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Nomor Rekening</label>
                                <input type="text" wire:model="company_bank_account_number" class="form-control">
                            </div>
                        </div>
                    </div>
